...
/**
 * @class OMV.module.admin.privilege.group.ldapgroup.General
 * @derived OMV.form.Panel
 * @param editMode Set to TRUE if the dialog is in edit mode. Defaults
 *   to FALSE.
 */
Ext.define("OMV.module.admin.privilege.group.ldapgroup.General", {
...
/**
 * @class OMV.module.admin.privilege.group.ldapgroup.Members
 * @derived OMV.grid.Panel
 */
Ext.define("OMV.module.admin.privilege.group.ldapgroup.Members", {
...
/**
 * @class OMV.module.admin.privilege.group.LdapGroup
 * @derived OMV.workspace.window.Tab
 */
Ext.define("OMV.module.admin.privilege.group.LdapGroup", {
	extend: "OMV.workspace.window.Tab",
	uses: [
		"OMV.module.admin.privilege.group.ldapgroup.General",
		"OMV.module.admin.privilege.group.ldapgroup.Members"
	],
	...
	getTabItems: function() {
		var me = this;
		return [
			Ext.create("OMV.module.admin.privilege.group.ldapgroup.General", {
				editMode: Ext.isDefined(me.rpcGetMethod)
			}),
			Ext.create("OMV.module.admin.privilege.group.ldapgroup.Members")
		];
	}
});

/**
 * @class OMV.module.admin.privilege.ldapgroup.SharedFolderPrivileges
 * @derived OMV.workspace.window.Grid
 * Display all shared folder privileges from the given group.
 */
Ext.define("OMV.module.admin.privilege.ldapgroup.SharedFolderPrivileges", {
...
/**
 * @class OMV.module.admin.privilege.group.LdapGroups
 * @derived OMV.workspace.grid.Panel
 */
Ext.define("OMV.module.admin.privilege.group.LdapGroups", {
	...
	uses: [
		"OMV.module.admin.privilege.group.LdapGroup",
		"OMV.module.admin.privilege.ldapgroup.SharedFolderPrivileges"
	],
	...
	onAddButton: function() {
		var me = this;
		Ext.create("OMV.module.admin.privilege.group.LdapGroup", {
			title: _("Add group"),
			listeners: {
				scope: me,
				submit: function() {
	...
	onPrivilegesButton: function() {
		var me = this;
		var record = me.getSelected();
		Ext.create("OMV.module.admin.privilege.ldapgroup.SharedFolderPrivileges", {
...
OMV.WorkspaceManager.registerPanel({
	...
	text: _("LDAP Groups"),
	position: 9,
	className: "OMV.module.admin.privilege.group.LdapGroups"
});
