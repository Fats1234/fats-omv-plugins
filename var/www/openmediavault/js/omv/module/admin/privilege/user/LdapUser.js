 ...
 *   to FALSE.
 */
Ext.define("OMV.module.admin.privilege.user.ldapuser.General", {
...
/**
 * @class OMV.module.admin.privilege.user.ldapuser.Groups
 * @derived OMV.grid.Panel
 */
Ext.define("OMV.module.admin.privilege.user.ldapuser.Groups", {
		...
		Ext.apply(me, {
			store: Ext.create("OMV.data.Store", {
				...
				proxy: {
					...
					appendSortParams: false,
					rpcData: {
						service: "LdapUserMgmt",
						method: "enumerateLdapGroups"
					}
				},
				sorters: [{
					direction: "ASC",
				...
				listeners: {
					...
					load: function(store, records) {
						...
						var record = store.findRecord("name", "ldapusers");
...
/**
 * @class OMV.module.admin.privilege.user.lddapuser.sshpubkeys.PubKey
 * @derived OMV.workspace.window.TextArea
 */
Ext.define("OMV.module.admin.privilege.user.ldapuser.sshpubkeys.PubKey", {
...
/**
 * @class OMV.module.admin.privilege.user.ldapuser.SshPubKeys
 * @derived OMV.workspace.grid.Panel
 */
Ext.define("OMV.module.admin.privilege.user.ldapuser.SshPubKeys", {
	...
	onAddButton: function() {
		var me = this;
		Ext.create("OMV.module.admin.privilege.user.ldapuser.sshpubkeys.PubKey", {
...
/**
 * @class OMV.module.admin.privilege.user.LdapUser
 * @derived OMV.workspace.window.Tab
 */
Ext.define("OMV.module.admin.privilege.user.LdapUser", {
	extend: "OMV.workspace.window.Tab",
	uses: [
		"OMV.module.admin.privilege.user.ldapuser.General",
		"OMV.module.admin.privilege.user.ldapuser.Groups",
		"OMV.module.admin.privilege.user.ldapuser.SshPubKeys"
	],

	rpcService: "LdapUserMgmt",
	...
	getTabItems: function() {
		var me = this;
		return [
			Ext.create("OMV.module.admin.privilege.user.ldapuser.General", {
				editMode: Ext.isDefined(me.rpcGetMethod)
			}),
			Ext.create("OMV.module.admin.privilege.user.ldapuser.Groups"),
			Ext.create("OMV.module.admin.privilege.user.ldapuser.SshPubKeys")
		];
	}
});

/**
 * @class OMV.module.admin.privilege.ldapuser.SharedFolderPrivileges
 * @derived OMV.workspace.window.Grid
 * Display all shared folder privileges from the given user.
 */
Ext.define("OMV.module.admin.privilege.ldapuser.SharedFolderPrivileges", {
...
/**
 * @class OMV.module.admin.privilege.user.LdapUsers
 * @derived OMV.workspace.grid.Panel
 */
Ext.define("OMV.module.admin.privilege.user.LdapUsers", {
	extend: "OMV.workspace.grid.Panel",
	requires: [
		"OMV.Rpc",
		"OMV.data.Store",
	...
	uses: [
		"OMV.module.admin.privilege.user.LdapUser",
		"OMV.module.admin.privilege.ldapuser.SharedFolderPrivileges"
	],
	...
	onAddButton: function() {
		var me = this;
		Ext.create("OMV.module.admin.privilege.user.LdapUser", {
			title: _("Add user"),
			listeners: {
				scope: me,
				submit: function() {
	...
	onPrivilegesButton: function() {
		var me = this;
		var record = me.getSelected();
		Ext.create("OMV.module.admin.privilege.ldapuser.SharedFolderPrivileges", {
...
OMV.WorkspaceManager.registerPanel({
	...
	text: _("LDAP Users"),
	position: 9,
	className: "OMV.module.admin.privilege.user.LdapUsers"
});
